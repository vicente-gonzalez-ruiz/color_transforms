...
transforms
\begin{enumerate}
\item \href{https://vicente-gonzalez-ruiz.github.io/color_transforms/docs/3DCT/HTML/}{DCT
    (Discrete Cosine Transform)} (applied to the color domain),
\item \href{https://vicente-gonzalez-ruiz.github.io/color_transforms/docs/YCbCr/HTML/}{$\text{YCrCb}$} transform, and
\item \href{https://vicente-gonzalez-ruiz.github.io/color_transforms/docs/YCoCg/HTML/}{$\text{YCoCg}$} transform,
\end{enumerate}
